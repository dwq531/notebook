...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NOTE_ID="note_id",COLUMN_TITLE="title",COLUMN_CREATE_TIME="create_time";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_NOTE_TABLE = String.format("CREATE TABLE %s (%s INTEGER, %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT,%s TEXT)",
                NOTE_TABLE_NAME,COLUMN_ID,COLUMN_NOTE_ID,COLUMN_TITLE,COLUMN_CREATE_TIME);
    ...
    public void updateContentPosition(long content_id,int position,int before_pos){
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
